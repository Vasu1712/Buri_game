...
var Player = /*#__PURE__*/function () {
  ...
  _createClass(Player, [{
    ...
    value: function update() {
      ...
      this.position.y += this.velocity.y; // this.draw()
...
var player = new Player(); // player.update()
...
function init() {
  ...
  player = new Player(); // player.update()
...
function animate() {
  ...
  if (scrollOffset > platformImage.width * 300 - 2) {
    console.log("You Win!");
  } // Lose
...
addEventListener('keydown', function (_ref3) {
  ...
  switch (keyCode) {
    ...
    case 39:
      ...
      player.currentCropWidth = player.sprites.run.cropWidth;
      player.width = player.sprites.run.width; //    player.velocity.x += 20
